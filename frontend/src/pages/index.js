    ...
    <div className="w-full">
      ...
      <div className="w-full bg-Neutral-200 justify-center flex px-4">
          <div className="flex md:flex-row flex-col justify-between items-center py-[50px] max-w-container w-full gap-4">
            <h2 className="mb-0 xl:text-[60px] lg:text-[55px] md:text-[50px] sm:text-[45px] text-[40px] sm:text-left text-center font-bold leading-tight tracking-[3.6px]">JOIN US THIS <br/> SUNDAY!</h2>
            <div className="flex flex-col items-center md:items-start">
              ...
              <div className="flex sm:justify-start justify-center text-center ">
                  <PrimaryButtonLink to={"/connect"} hasArrow={true}>Plan Your Visit</PrimaryButtonLink>
              </div>
            </div>
          </div>
      </div>
