            ...
            <div className="flex flex-col items-start mt-[30px]">
              ...
              <div className="flex flex-row justify-center items-center mt-[15px]">
                ...
                <a
                  ...
                  className="text-Shades-0 font-bold text-center text-sm leading-normal mb-0 ml-[12px] no-underline hover:opacity-75"
                >
          ...
          <div className="flex flex-row justify-between w-full mb-[62px]">
            <div className="flex flex-row justify-center items-center">
              <img
                ...
                src={copyrightLogo}
              />
              <h2 className="text-Shades-0 text-[16px] font-bold mb-0 ml-[4px]">
                2023
              </h2>
              <a
                href="https://annarbor.hmcc.net"
                className="text-Shades-0 text-[16px] font-bold mb-0 ml-[4px] no-underline hover:opacity-75"
              >
                HARVEST MISSION COMMUNITY CHURCH
              </a>
            </div>
