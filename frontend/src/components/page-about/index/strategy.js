  ...
  <div className={container}>
    ...
    <div className={`${step} ${step3}`}>
      ...
      <div>
        ...
        <div>
          We have been called to go out and make disciples, by sharing the Good
          News and testifying of the work God has done in our lives.
          <ul>
            <li>
              Personal Mission happens when an individual lives as the salt and
              light in our world, shares his/her faith with others and invites
              people into our community.
            </li>
            <li>
              Team-Based Mission happens when we partner together for God’s
              kingdom purposes through opportunities like missional initiatives,
              missions teams, and church plant teams.
            </li>
          </ul>
        </div>
      </div>
    ...
    <div className={`${step} ${step1}`}>
      ...
      <div>
        ...
        <div>
          We gather to foster a greater sense of unity and to continue to build
          up the church body.
          <ul>
            <li>
              Corporate Gatherings are what we do together as the local body of
              Christ, such as Sunday Celebration, retreats, and baptism
              services.
            </li>
            <li>
