...
const Strategy = () => (
  <div className={container}>
    <div className={titleContainer}>
      ...
      <h2>The <span className="text-Accent-700">3G</span>&apos;s: Gather, Grow, Go</h2>
    </div>
        ...
        <div className={`${step} ${step3}`}>
          <div className="lg:relative lg:pl-[66px]">
            <div className="flex items-center pb-3 lg:pb-0 lg:block">
              ...
              <h3><span className="text-Accent-700">Go:</span> Personal Mission & Team-Based Mission</h3>
            </div>
            <div>
        ...
        <div className={`${step} ${step2}`}>
          <div className="lg:relative lg:pl-[66px]">
            <div className="flex items-center pb-3 lg:pb-0 lg:block">
              ...
              <h3><span className="text-Accent-700">Grow:</span> Life-on-Life & Equipping</h3>
            </div>
            <div>
        ...
        <div className={`${step} ${step1}`}>
          <div className="lg:relative lg:pl-[66px]">
            <div className="flex items-center lg:block">
              ...
              <h3><span className="text-Accent-700">Gather:</span> Corporate Gatherings & Community Gatherings</h3>
            </div>
            <div>
