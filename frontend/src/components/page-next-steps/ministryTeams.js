...
import { AdsLogo, KidsLogo, DocsLogo, HostsLogo, FacilitiesLogo, VMLogo, WorshipLogo } from "../svgs";
            ...
            teams.map((item, index) => {
                ...
                switch (teamItem) {
                    case "A": 
                        ...
                        break;
                    case "B": 
                        className = "lg:top-[12.5375rem] xl:top-[19.9375rem] lg:-right-[3.775rem] xl:-right-[14.875rem]";
                        break;
                    case "D":
                        className = "lg:top-[1.875rem] lg:-right-[1.25rem]";
                        break;
                    case "H": 
                        className = "lg:top-[39.0625rem] lg:-right-[2.6875rem] xl:-right-[9.6875rem]"
                        break;
                    case "S":
                        className  = "lg:-bottom-[2.8125rem] lg:left-[17.1875rem]";
                        break;
                    case "V":
                        className = "lg:bottom-[9.6875rem] lg:-left-[3.875rem] xl:-left-[4.875rem]";
                        break;
                    case "W":
                        className = "lg:top-[12.5375rem] xl:top-[19.9375rem] lg:-left-[3.85rem] xl:-left-[11.25rem]";
                        break;
                    default:
                }
                return (
