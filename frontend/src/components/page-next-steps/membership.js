...
const Membership = () => (
  <div className="max-w-container w-full py-5 md:py-15 flex justify-center items-center">
    <div className="w-full border-2 border-solid border-Neutral-600 py-5 md:py-15 flex flex-col text-center px-2 [@media(min-width:375px)]:px-[0.875rem] md:px-8 rounded-2xl items-center">
