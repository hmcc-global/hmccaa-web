...
const MapDetails = () => {
  return (
    <div className="flex flex-col w-full text-center justify-center pt-5 bg-Primary-700 lg:flex-row lg:max-w-[73.75rem] lg:pt-0 lg:rounded-2xl">
      <div className="flex flex-col gap-5 pb-4 lg:gap-0 lg:flex-[0_0_18.25rem] xl:flex-[0_0_26.25rem] lg:px-4 xl:px-17 lg:py-11">
      ...
      <div className="lg:max-w-[47.5rem] py-2 lg:flex-[0_1_auto] lg:pr-[12px]">
        <div className="lg:w-full h-full lg:overflow-hidden lg:rounded-tr-2xl lg:rounded-br-2xl border-[#D0E3ED] border-solid border-y-0 lg:border-y-[8px] border-x-[14px] bg-[#D0E3ED]">
          <StaticImage
            src="../../images/connect-updated-map-parking.png"
            alt=""
