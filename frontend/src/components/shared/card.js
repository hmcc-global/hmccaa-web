...
const Card = ({
  ...
  return (
    <Link to={href} className="no-underline text-Shades-100 font-normal">
      <div
        className={`flex flex-col items-center gap-2 pb-5 mx-auto rounded-xl border border-solid border-b-Neutral-900 shadow-md overflow-hidden ${containerCss} md:gap-5 h-full`}
      >
        {img}
