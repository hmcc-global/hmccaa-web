  ...
  <div className="flex pb-20 pt-20 flex-col items-center m-auto max-w-[640px] text-center gap-[60px]">
    ...
    <div className="flex justify-center">
      <div className="flex flex-col items-center max-w-[280px] p-2.5 gap-5">
        <div className="m-2.5 w-25 h-25 flex items-center">
          <LaptopIcon />
        </div>
        <div className="text-Primary-500 font-semibold text-3xl uppercase ">
          Give Online
        </div>
      ...
      <div className="flex flex-col items-center max-w-[280px] p-2.5">
        ...
        <div className="text-Primary-500 font-semibold text-3xl uppercase mt-5 mb-3">
          Give By Mail
        </div>
        <p className="mb-5">
          Harvest Mission
    ...
    <div className="max-w-[620px]">
      <p>
        ...
        any questions, please email <b>stewardship@hmcc.net</b>
      </p>
      <p className="mb-0">
