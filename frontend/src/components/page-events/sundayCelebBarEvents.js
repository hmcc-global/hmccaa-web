...
const SundayCelebBarEvents = () => {
  return (
    <div className="bg-Neutral-200 w-full flex justify-center items-center py-[17px] lg:py-[30px] px-4  lg:px-[32px] xl:px-[65px] 2xl:px-[130px] lg:mt-0 mt-[3px]">
      <div className="bg-Shades-0 items-center h-full border-solid border-2 max-w-container rounded-xl py-10 lg:py-9 px-[14px] lg:px-8 2xl:px-24 border-Neutral-700 space-x-28">
